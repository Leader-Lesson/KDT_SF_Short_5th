    ...
    public partial class MainWindow : System.Windows.Window
    {
        ...
        public static async Task<string> OCR(Mat src)
        {
            try
            {
                ...
                string filePath = Path.Combine(tessdataFolderPath, "eng.traineddata");
        ...
        private static async Task DownloadTrainedData(string tessdataFolderPath)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var filePath = Path.Combine(tessdataFolderPath, tessdataEngFileName);
