...
namespace WindowsFormsApp_09_Class_UpCasting
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            // Why?
            // 다형성을 통해 여러 자식 객체를 부모 타입 하나로 통합하여 유연하고 재사용 가능한 코드로 작성하기 위해
            ...
            // -[참고] 이 또한 묵시적 업캐스팅 (구별하기 위해 비공식 용어)
            ...
            // ㄴ 다운캐스팅은 실행 중 타입이 맞지 않으면 예외(오류)가 발생하기 때문에,
            // ㄴ 안정성이 떨어지며 유지보수와 확장성에도 불리함.
            // [참고] 이 방법 말고도 is, as키워드 사용해서 하는 방법있는데 굳이 ㄴㄴ
            // [참고] 다운캐스팅 하지 않고 자식 기능 호출 가능한 방법을 배울 것임 (virtual + override)
