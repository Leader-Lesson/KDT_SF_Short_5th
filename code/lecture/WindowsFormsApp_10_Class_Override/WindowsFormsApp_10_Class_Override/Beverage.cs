...
namespace WindowsFormsApp_10_Class_Override
{
    ...
    public class Beverage
    {
        ...
        // #2. 오버라이드
        // ㄴ 부모 클래스의 메서드를 자식 클래스에서 다시 재정의(덮어쓰기) 하는 것!
        // Why?
        // ㄴ 부모 클래스가 기본 기능을 제공하되,
        //    자식 클래스에서는 그 기능을 자신만의 방식으로 바꿔야 할 때가 많을 때 사용!
        // 조건)
    ...
    {
        // 오류 발생! sealed 때문에 더 이상 오버라이드 불가.
        //public override void Prepare()
        //{
    ...
    {
        // Latte 클래스를 상속 받지 않았기 때문에,
        // sealed 영향을 받지 않음 -> override 가능!
        public override void Prepare()
        {
            Console.WriteLine("콜드브루를 준비하고 있습니다.");
        }
